...
if (Tasmanian_ENABLE_MATLAB AND (NOT DEFINED Tasmanian_MATLAB_WORK_FOLDER))
    message(FATAL_ERROR "Tasmanian_ENABLE_MATLAB is ON, but -D Tasmanian_MATLAB_WORK_FOLDER:PATH=<path> is missing\nIn order to enable the MATLAB interface, you must specify -D Tasmanian_MATLAB_WORK_FOLDER:PATH=")
endif()
...
if (Tasmanian_ENABLE_CUBLAS OR Tasmanian_ENABLE_CUDA)
    if (Tasmanian_ENABLE_CUDA OR (NOT DEFINED CUDA_CUBLAS_LIBRARIES))
        find_package(CUDA)
