  ...
  if(SWIG_FIND_COMPONENTS)
    ...
    if(SWIG_swighelp_result)
      if(SWIG_FIND_COMPONENTS)
        ...
        message(STATUS "Command \"${SWIG_EXECUTABLE} -help\" failed with output:\n${SWIG_swiglib_error}")
      endif()
    else()
      string(REPLACE "\n" ";" SWIG_swighelp_output "${SWIG_swighelp_output}")
      foreach(_line IN LISTS SWIG_swighelp_output)
        if(_line MATCHES "-([A-Za-z0-9_]+) +- *Generate.*wrappers")
