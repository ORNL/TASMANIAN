...
shift = 1.0
nref = 49
description = "Sinc-Weighted Quadrature"
sinc10 = lambda x: 1.0 if x == 0.0 else math.sin(10 * x) / (10 * x)
ct = TasmanianAddons.createExoticQuadratureFromFunction(level, shift, sinc10, nref, description)
